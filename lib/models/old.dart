...
enum Typename { AGGREGATION_OPTION }

final typenameValues =
    EnumValues({"AggregationOption": Typename.AGGREGATION_OPTION});
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
        ...
        priceRange: json["price_range"] == null
            ? PriceRange(
                ...
                minimumPrice: MinimumPrice(
                    typename: "",
                    regularPrice:
                        RegularPrice(typename: "", currency: "", value: 0)))
        ...
        getPriceRange: json["getPriceRange"] == null
            ? []
            : List<GetPriceRange>.from(
                json["getPriceRange"].map((x) => GetPriceRange.fromJson(x))),
        textAttributes: json["textAttributes"] == null
            ? []
            : List<TextAttribute>.from(
                json["textAttributes"].map((x) => TextAttribute.fromJson(x))),
        dynamicAttributes: json["dynamicAttributes"] == null
            ? []
            : List<DynamicAttribute>.from(json["dynamicAttributes"]
                .map((x) => DynamicAttribute.fromJson(x))),
        urlKey: json["url_key"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "getPriceRange":
            List<dynamic>.from(getPriceRange.map((x) => x.toJson())),
        "textAttributes":
            List<dynamic>.from(textAttributes.map((x) => x.toJson())),
        "dynamicAttributes":
            List<dynamic>.from(dynamicAttributes.map((x) => x.toJson())),
        "url_key": urlKey,
...
class Value {
  ...
  factory Value.fromJson(Map<String, dynamic> json) => Value(
        ...
        swatchData: json["swatch_data"] == null
            ? SwatchData(typename: 'typename', value: 'value')
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        smallImage:
            json["small_image"] ?? SmallImage.fromJson(json["small_image"]),
        textAttributes: json["textAttributes"] == null
            ? []
            : List<TextAttribute>.from(
                json["textAttributes"].map((x) => TextAttribute.fromJson(x))),
