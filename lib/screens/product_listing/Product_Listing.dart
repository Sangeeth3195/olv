                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Text('Apply Filters',   style: const TextStyle(
                                fontWeight:
                                FontWeight.bold,
                                color: priceColor,
                                height: 1.5,
                      ...
                      SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (BuildContext context,
                                  ...
                                  children: [
                                    ...
                                    subitemIndex]
                                      ...
                                      child: RangeSlider(
                                        ...
                                        min: 0,
                                        max: 300,
                                        divisions: 30, // Optional: Increase for a smoother slider
                                          ...
                                          provider
                                            ...
                                            return CheckboxListTile(
                                              ...
                                              title: Container(
                                                height: 12,
                                                width: 12,
                                                child: Text(provider.aggregationList[
                                        ...
                                        provider
                                          ...
                                          return CheckboxListTile(
                                            ...
                                            title: Text(
                                                provider.aggregationList[
                                                subitemIndex].options
                                                [index].label+" (${provider.aggregationList[
                                                subitemIndex].options
                                                [index].count}) ",
                                                style: const TextStyle(
                                                    fontWeight:
                            ...
                            return Container();
                            return const Divider(height: 0.2,thickness: 1,);
                        },
                        ),
                      ),
                      Container(
