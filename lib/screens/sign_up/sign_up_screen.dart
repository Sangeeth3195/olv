            ...
            Padding(
              ...
              child: GestureDetector(
                ...
                child:Column(
                  ...
                  children: <Widget>[
                    const Padding(
                padding: EdgeInsets.fromLTRB(10.0, 0.0, 10.0, 0),child: Text(
        ...
        children: <Widget>[
          ...
          child: Padding(
              ...
              child: Text.rich(
                TextSpan(
                  children: [
                    const TextSpan(text: 'Already have an account? ', style: TextStyle(fontWeight: FontWeight.w600,color: Colors.black)),
                    TextSpan(
                      text: 'Log In',
